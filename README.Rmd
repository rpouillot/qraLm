...
- You must first install the `doseresponsemodels` package from `GitHub`: [https://github.com/WorldHealthOrganization/doseresponsemodels/](https://github.com/WorldHealthOrganization/doseresponsemodels/), which implements the dose-response models for Listeria monocytogenes.
