...
- You must first install the `doseresponsemodels` package from `GitHub`: [https://github.com/rpouillot/doseresponsemodels/](https://github.com/rpouillot/doseresponsemodels/), which implements the dose-response models for Listeria monocytogenes.
